        ...
        <div className="px-8 py-12 mx-auto max-w-7xl">
          <div className="grid grid-cols-2 gap-10 mb-3 md:grid-cols-3 lg:grid-cols-12 lg:gap-20">
            <div className="col-span-3">
              ...
              <p className="my-4 text-xs leading-normal text-gray-500">
                ...
                atque velit aperiam quo laudantium, ullam debitis.
              </p>
            </div>
            ...
            <nav className="col-span-2 md:col-span-1 lg:col-span-2">
              ...
              <a
                href="#"
                className="flex mb-3 text-sm font-bold text-purple-700 transition hover:text-gray-700 md:mb-2 hover:text-primary"
              >
                United@um6p.com
              </a>
              <div className="flex mb-3 text-sm font-medium text-gray-500 transition hover:text-gray-700 md:mb-2 hover:text-primary">
                + 212 5 234 567 88
              </div>
            </nav>
            <div className="col-span-3">
              ...
              <div className={styles.apps}>
                <h1 className={styles.apps_title}>Discover our app</h1>
          ...
          <div className="flex flex-col items-start justify-between pt-10 mt-10 border-t border-gray-100 md:flex-row md:items-center">
            <p className="mb-6 text-sm text-left text-gray-600 md:mb-0">
              © Copyright 2022 <span className="font-bold">United</span>. All Rights Reserved.
            </p>
