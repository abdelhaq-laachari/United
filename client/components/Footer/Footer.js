        ...
        <div class="px-8 py-12 mx-auto max-w-7xl">
          <div class="grid grid-cols-2 gap-10 mb-3 md:grid-cols-3 lg:grid-cols-12 lg:gap-20">
            ...
            <nav class="col-span-2 md:col-span-1 lg:col-span-2">
              ...
              <a
                href="#"
                class="flex mb-3 text-sm font-bold text-purple-700 transition hover:text-gray-700 md:mb-2 hover:text-primary"
              >
                United@um6p.com
              </a>
              <div class="flex mb-3 text-sm font-medium text-gray-500 transition hover:text-gray-700 md:mb-2 hover:text-primary">
                + 212 5 234 567 88
              </div>
            </nav>
            <div class="col-span-3">
