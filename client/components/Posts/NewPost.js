    ...
    <div className={styles.container}>
      ...
      <div className={styles.bottom}>
        <div className={styles.attachment}>
          <div className={styles.attachment_vid}>
            <svg
              fill="currentColor"
              viewBox="0 0 24 24"
              width="1em"
          ...
          <span className={styles.attachment_span}>Video</span>
        </div>
        <div className={styles.attachment}>
          <div className={styles.attachment_img}>
            <svg
              fill="currentColor"
              viewBox="0 0 24 24"
              width="1em"
          ...
          <span className={styles.attachment_span}>Photo</span>
        </div>
        <div className={styles.attachment}>
          <div className={styles.attachment_feeling}>
            <svg
              fill="currentColor"
              viewBox="0 0 24 24"
              width="1em"
          ...
          <span className={styles.attachment_span}>Feeling/activity</span>
        </div>
      </div>
    </div>
  );
