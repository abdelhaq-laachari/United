  ...
  return (
    <div className={styles.bg}>
      ...
      <div className={styles.second_section}>
        <div className={styles.white_break}>
          {/* top shape start */}
      ...
      <div className={styles.fourth_section}>
        <div className={styles.break_white}>
          {/* top shape start */}
          <div className={styles.custom_shape_divider_top_1661243877}>
            <svg
              data-name="Layer 1"
          ...
          <div className={styles.content_fourth_section}>
            <div className={styles.fourth_title}>
              ...
              <p>
                M As Their Default Model Text, And A Search For 'Lorem Ipsum'
            ...
            <div className={styles.right_content}>
              ...
              <div className={styles.card}>
                <div className={styles.card_fourth_section}>
                  ...
                  <div className={styles.par_fourth_section}>
                    <p>
